...
for xd in range(10000):
	...
	d='Samsung Galaxy S22'
	e=random.randrange(100, 9999)
	f='/80.0.3987.119 Mobile Safari/537.36/'
	...
	g='AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/69.0.3497.100 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/193.0.0.45.101;]/'
	...
	ugen.append(uaku2)
for x in range(10):
	a='Mozilla/5.0 (Linux; Android 7.0; SM-G610M Build/NRD90M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/69.0.3497.100 Mobile  Safari/537.36 [FB_IAB/FB4A;FBAV/193.0.0.45.101;]'
...
def grup():
	...
	ua = 'Mozilla/5.0 (Linux; Android 7.0; SM-G610M Build/NRD90M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/70.0.3538.80 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/197.0.0.46.98;]'
...
def grup1(urls):
	...
	while True:
		try:
			ua = 'Mozilla/5.0 (Linux; Android 7.0; SM-G610M Build/NRD90M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/69.0.3497.100 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/191.0.0.35.96;]'
			miskinlu = {"user-agent": ua}
			try:
				url = use[0]
			except:
